...
public class ValueTest extends AbstractFunctionTest {
   @Override
   ...
   public void testEvaluate() {
      evaluate("(value (create-pair 3 7))").to(7);
   }
   ...
   public void testGetSignature() {
      ...
      assertSame(entryType(integerType(), booleanType()), signature.getArgumentType(0));
   }
}
