...
public class IfTest extends AbstractFunctionTest {
   ...
   public void testCanSimplify() {
      ...
      Type[] integers = { integerType(), integerType(), integerType(), integerType(), integerType(), integerType(), integerType(), integerType() };

      simplify("(if (< 1 2) 4 7)").with(integers).to("4");
      simplify("(if (> 1 2) 4 7)").with(integers).to("7");
      simplify("(if (> v0 v1) v2 v2)").with(integers).to("v2");

      simplify("(if (> v0 v1) v3 v4)").with(integers).to("(if (< v1 v0) v3 v4)");

      simplify("(if (< v0 v1) (if (< v0 v1) v2 v3) v4)").with(integers).to("(if (< v0 v1) v2 v4)");
      simplify("(if (< v0 v1) v2 (if (< v0 v1) v3 v4))").with(integers).to("(if (< v0 v1) v2 v4)");

      simplify("(if (< v0 v1) (+ v2 (if (< v0 v1) v3 v4)) v5)").with(integers).to("(if (< v0 v1) (+ v2 v3) v5)");
      simplify("(if (< v0 v1) v5 (+ v2 (if (< v0 v1) v3 v4)))").with(integers).to("(if (< v0 v1) v5 (+ v2 v4))");

      simplify("(if (< v0 v1) (if (< v2 v3) (if (< v0 v1) v4 v5) v6) v7)").with(integers).to("(if (< v0 v1) (if (< v2 v3) v4 v6) v7)");
      simplify("(if (< v0 v1) v7 (if (< v2 v3) (if (< v0 v1) v4 v5) v6))").with(integers).to("(if (< v0 v1) v7 (if (< v2 v3) v5 v6))");
   }
