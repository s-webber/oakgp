...
public class CommonRegionTest {
   ...
   public void test() {
      ...
      assertNodeEquals("(+ 7 (+ 8 9))", cr.crossoverAt(n1, n2, 0));
      assertNodeEquals("(+ (+ 1 2) (+ 8 9))", cr.crossoverAt(n1, n2, 1));
      assertNodeEquals("(+ (+ 1 2) (+ 8 4))", cr.crossoverAt(n1, n2, 2));
      assertNodeEquals("(+ (+ 1 2) (+ 3 9))", cr.crossoverAt(n1, n2, 3));
   }
}
