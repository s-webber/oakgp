...
public class NodeSimplifierTest {
	...
	public void testVeryDeeplyNestedTreeSimplifedByOperator4() {
		...
		String expected = "(+ (if (- 4 (+ v2 v4)) (+ (+ (* v4 (+ v1 v3)) (- v1 (- (* v3 (* v0 v2)) 1))) (if (- v4 (- (* 3 (if (- (* 3 v3) v2) (+ (if v1 v2 v1) (* (if (- -1 (* v2 (+ 1 v1))) 3 v1) (- (+ v3 (* v1 v2)) (if (- v3 (if (- (if (- 3 v4) v4 0) (- v4 v3)) (- v1 v4) v1)) (- (- v2 (- v3 (* v1 v2))) v4) v1)))) v4)) (* 9 v2))) 3 (+ v1 (- (* v4 (- v3 v1)) (* v1 (* v1 (- (- v1 v4) (* v3 (* v0 v2))))))))) (+ (- (if v4 v4 v1) (- 0 v2)) (if (* (if v1 v2 v1) (- v3 (if (- (+ (* 2 v3) (- (* 3 v1) 3)) (if (* v3 (- (if (+ (- (* v1 v4) (+ v4 (* (- (* 2 v1) v4) (if (- (* v4 (- v3 v1)) (- (if (- (* v1 (if (- v3 (if (* (- (+ v1 v3) (* 12 v2)) (- v3 (+ v1 v2))) (* (if (- (* v1 (+ v3 (+ 1 v1))) (* v2 (if (- (* v4 (- (- v1 1) (if (- 1 v4) v4 v1))) (- v3 (* 3 (* v1 v2)))) (- v1 v4) v1))) v2 v1) (+ v1 (- (- v0 3) (* v2 v3)))) (- (+ 4 (if (- (if (- v3 (if (+ (- v3 v2) (- v4 (* 4 (* v1 v4)))) (- (- (- (* 2 v1) v4) (- v3 (* v0 v2))) (if (- (* v4 (- v3 v1)) (* v2 (- v3 (- (+ (- (if v4 v4 v1) (- 0 v2)) (if (* (if v1 v2 v1) (- v3 (if (- (+ (* 2 v3) (- (* 3 v1) 3)) (if (* v3 (- (if (+ (- v3 (+ v1 v2)) (- (* v1 v4) (* v4 (* (- (* 2 v1) v4) (if (- (* v4 (- v3 v1)) (* v2 (if (- (* v1 (if (- v3 (if (* (- 0 v1) (- (+ v1 v3) (* 12 v2))) (* (+ v1 (- (- v0 3) (* v2 v3))) (if (- (+ (* 3 v1) (* 3 v3)) (* v2 (if (- (* v4 (- (- v1 1) (if (- 1 v4) v4 v1))) (- v3 (* 3 (* v1 v2)))) (- v1 v4) v1))) v2 v1)) (- (+ 4 (if (- (if (- v3 (if (+ (- v3 v2) (- v4 (* 4 (* v1 v4)))) (- (+ v1 (- (* v0 v2) v3)) (if (- (- (* 2 v3) (* 2 v1)) (* v2 (if (+ (* v1 (- (- v1 1) v3)) (- v3 (* 3 (* v1 v2)))) (* v1 v4) v1))) v2 v1)) (- (- (if (- v1 v4) v4 v1) 1) v3))) (* v2 (if v1 v2 v1)) v4) v4) v4 v1)) v3))) (* v2 (if v1 v4 v1)) v4)) (- v3 (- (- 9 (* 3 v4)) (* 12 v2)))) (* v1 v4) v1))) v2 v4))))) (* (if (- 3 (* v2 (if (- (- (* 2 v1) (if (- 1 v4) 1 v1)) (+ (* -3 v2) (+ 4 (* 4 v4)))) (- v1 v4) v1))) v2 v1) (- (- (* 2 v1) v2) (* v3 (* v0 v2)))) (+ 3 (if (- v1 v3) 1 v1))) (* 2 v3))) (* (if v4 v2 v1) (if (- 1 v4) v4 0)) v4)) 3 v1))) (- v1 (* v1 v2)) v1)) (if (+ (* v1 (- (- v1 1) (if (- 1 v4) v4 v1))) (- v3 (* 3 (* v1 v2)))) (- v1 v4) v1))))) v2 v1)) (- (- (if (- v1 v4) v4 v1) 1) v3))) (* v2 (if v1 v4 v1)) v4) v4) v4 v1)) v3))) (* v2 (if v1 v4 v1)) v4)) (- v3 (- (- 9 (* 3 v4)) (* 12 v2)))) (+ v1 v4) v1) v2)) v2 v4)))) (- v3 (+ v1 v2))) (* (* v1 (- (- v1 v2) (* v3 (* v0 v2)))) (if (- v3 (* v2 (if (- (- (* 2 v1) (if (- 1 v4) v4 v1)) (+ (* -3 v2) (+ 4 (* 4 v4)))) (- v1 v4) v1))) v2 v1)) (+ 3 (if (- v1 v3) 1 v1))) (* 2 v3))) (* (if v4 v2 v1) (if (- 1 v4) v4 0)) v4)) 3 v1))) (- v1 (* v1 v2)) v1))) (- (* 2 v4) 3))";
		assertDeeplyNestedTreeSimplifedByOperator(input, expected);
	}
