...
public class NodeSimplifierTest {
   ...
   public void testDeeplyNestedTreeSimplifedToFunction6() {
      ...
      assertCanSimplify("(+ (* 2 v0) (+ 10 v1))", "(+ 2 (+ (* 2 v0) (+ 8 v1)))");
   }
   ...
   public void testDeeplyNestedTreeSimplifedToFunction14() {
      assertCanSimplify(
            "(- (+ 432 (* -108 v2)) (* 81 (* (+ (+ 819 (* 324 v0)) (* 180 v2)) (- (* -3 v2) 3))))",
   ...
   public void testDeeplyNestedTreeSimplifedToFunction15() {
      assertCanSimplify("(+ (+ 819 (* 324 v0)) (* 180 v2))", "(- (- (* 162 v0) (* -81 v2)) (+ (- (* -162 v0) 819) (* -99 v2)))");
   }
   ...
   // had to comment out as with new type enforcement this example is not valid (as now the first argument of "if" *has* to be a boolean)
   // @Test
