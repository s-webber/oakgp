...
final class Sum<T extends Comparable<T>> implements Function {
   ...
   @Override
   public T evaluate(ChildNodes arguments, Assignments assignments, AutomaticallyDefinedFunctions adfs) {
      Collection<T> input = arguments.first().evaluate(assignments, adfs);
