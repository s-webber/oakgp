...
public final class RunBuilder {
   ...
   public class PrimitiveSetSetter {
      ...
      public VariablesSetter setConstants(final ConstantSet constantSet) {
      ...
      public VariablesSetter setConstants(final ConstantNode... constants) {
         return setConstants(new ConstantSet(constants));
      }
   ...
   public final class VariablesSetter {
      ...
      public VariablesRatioSetter setVariables(final VariableSet variableSet) {
      ...
      public VariablesRatioSetter setVariables(final Type... variableTypes) {
         return setVariables(VariableSet.createVariableSet(variableTypes));
      }
   }
