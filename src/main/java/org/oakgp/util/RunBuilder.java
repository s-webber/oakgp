...
public final class RunBuilder {
   ...
   /**
    * Sets the required {@code Type} associated with the values produced as a result of evaluating the programs that are
    * automatically generated by the run.
    */
   ...
   /**
    * Provides the option to set a random number generator, or to skip that option and instead configure the primitive
    * set.
    * <p>
    * If you do not explicitly specify a random number generator then the {@code RunBuilder} will default to using
    * {@link JavaUtilRandomAdapter}. Unless you have a specific requirement about how random numbers are generated then
    * the default random number generator will be sufficient.
    */
   ...
   public class PrimitiveSetSetter {
      ...
      /**
       * Sets the functions and terminal nodes that are available for use in the construction of programs generated by
       * the run.
       */
   ...
   public final class VariablesSetter {
      ...
      /**
       * Sets the {@code Type}s to associate with the variables available for use in the construction of programs
   ...
   public final class VariablesRatioSetter implements FunctionSetSetter {
       ...
       *
       * @param ratioVariables a value in the range 0 to 1 (inclusive) which specifies the proportion of terminal nodes
       * that should represent variables, rather than constants
   ...
   public class GenerationRankerSetter {
      ...
      private FitnessFunction ensureCached(final FitnessFunction fitnessFunction) {
         //TODO add cache option so not automatically applied
   ...
   private class MaxGenerationsTerminatorSetterImpl extends MaxGenerationsWithoutImprovementTerminatorSetterImpl implements MaxGenerationsTerminatorSetterOrProcessRunner {
   ...
   public interface ProcessRunner {
       ...
       *
       * @return the final generation produced as part of this run - the best candidate of this generation can be
       * retrieved using {@link RankedCandidates#best()}
       */
